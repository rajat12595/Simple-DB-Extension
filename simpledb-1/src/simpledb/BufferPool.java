...
public class BufferPool {
	...
	public Page getPage(TransactionId tid, PageId pid, Permissions perm) throws TransactionAbortedException,
		...
		// some code goes here
			...
			{
				if(pages.size() >= numPages-1 )
				{
					throw new DbException("CANNOT BE PROCESSED ");
				}
				else 
				{
				DbFile N1=Database.getCatalog().getDbFile(pid.getTableId());
				System.out.println(N1);
				Page p2=N1.readPage(pid);
