...
public class HeapPage implements Page {
	...
	public Iterator<Tuple> iterator() {
		List<Tuple> new_list = new ArrayList<Tuple>();
		Integer t=entryCount(); 
		for(int i=0; i < t; i++)
		{ 
		if( getTuple(i)!=(null))  
		    new_list.add(getTuple(i));
	...
	public void deleteTuple(Tuple t) throws DbException {
		...
		{
			throw new DbException("File already deleted");
		}
	...
	public Tuple getTuple(int entryID) {
		if(entryID < readInt(data, 0))
		{
		Integer location= tupleLocation(entryID);
	...
	protected int tupleLocation(int entryID) {
		Integer TL=readInt(data,4 + 4 * entryID);
		return TL;
	}
